...
import { FaCog, FaPlus, FaQuestionCircle, FaSyncAlt } from 'react-icons/fa';
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* <li  className="space-y-3 w-full"> */}
              {/* <button className="w-full flex items-center gap-2 p-3 bg-gradient-to-r from-red-600 via-orange-600 to-red-500 text-white rounded-lg shadow-md hover:opacity-90 transition">
                <FaPlus size={14} />
                Add drivers
              </button> */}
{/* 
              <button className="w-full flex items-center gap-2 p-3 bg-gray-800 text-white rounded-lg shadow-md hover:bg-gray-700 transition">
                <FaCog size={14} />
                Settings
              </button>
              <button className="w-full flex items-center gap-2 p-3 bg-gray-800 text-white rounded-lg shadow-md hover:bg-gray-700 transition">
              ...
              <p className="w-full text-center p-3 text-white font-bold">
                Fleet Name
              </p>
              </li> */}
              {/* <!-- Menu Item Chart --> */}
